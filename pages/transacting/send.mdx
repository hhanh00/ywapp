...
![Simple Send](./send/2024-03-07_14-02-22.png)
...
will respectively:
- open the [QR scanner](/qr#scan)
- ask you to pick up a [contact](/contacts)
...
in the [settings](/settings/general#custom-send),
...
![Custom Send](./send/2024-03-07_20-27-05.png)

1. [Address](/)
1. [QR Code Scanner](/balance/addresses)
1. [Address Book / Contacts](/contacts)
1. [Accounts](/accounts)
...
by
[Receivers](/settings/coin#receivers) in the settings.
...
1. Amount in Crypto
1. Amount in Fiat / [Reference Currency](/settings/general#currency)
1. Amount Slider
1. Max Amount
...
[settings](/settings/view#custom-send).
</Callout>
...
in the
[Settings](/settings/coin#receivers).
