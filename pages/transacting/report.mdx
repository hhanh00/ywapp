...
![](./report/2024-03-10_18-17-59.png)
...
You can set a
[minimum level of privacy](/settings/privacy#min-level).
If
...
Once the transaction is sent, the app shows
the transaction ID and you can see it on a
block explorer.

![Sent](./send/2024-05-09_23-37-45.png)
