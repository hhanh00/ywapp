...
For more info, see
[Synchronization](/sync#transparent-data).

![Notes](./notes/2024-03-10_14-17-02.png)
...
When it reaches a point where the user considers the risk acceptable, they consider the transaction fully confirmed. Since this is subjective, Ywallet has a [setting](/settings/privacy)
